...
# docker run -d -p 80:80 -e SECRET_KEY_BASE=<value from bin/rails secret> --name fitxa_cae fitxa_cae
...
# Precompile assets for production without requiring the real SECRET_KEY_BASE.
